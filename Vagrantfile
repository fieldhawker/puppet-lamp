...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder ".", "/etc/puppet/modules/puppet", :mount_options => ["dmode=777", "fmode=666"]
  ...
  config.vm.provision :puppet do |puppet|
    ...
    puppet.facter = {
      ...
      "myname"         => "puppet-lamp",
      "myaddr"         => "192.168.33.20",
      "admin"          => "root@puppet-lamp.vagrantup.com",
      "httpport"       => "80",
      "mysql_password" => ""
    }
